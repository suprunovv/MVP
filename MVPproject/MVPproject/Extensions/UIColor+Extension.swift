...
extension UIColor {
    ...
    static let loginButtonColor = UIColor(red: 4 / 255.0, green: 38 / 255.0, blue: 40 / 255.0, alpha: 1)
    static let errorColor = UIColor(red: 240 / 255.0, green: 97 / 255.0, blue: 85 / 255.0, alpha: 1)
}
